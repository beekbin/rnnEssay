...
\author{Songbin Liu \\\\ apple.songbin@gmail.com} % The authors name
%\email{}
...
%In this wiki, the Backpropagation Through Time (BPTT) process is explained for training RNN and LSTM. 
